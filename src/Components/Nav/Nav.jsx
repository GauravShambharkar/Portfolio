  ...
  return (
    <>
      <div className="w-full  xcenter fixed top-0 z-50">
        <div className="w-190 h-12 bg-[#00000000] backdrop-blur-md borderb text-xl ycenter px-2 xcenter gap-2  xbetween text-white ">
          ...
          <div className="flex gap-2 font-light ">
            ...
            <a
              ...
              className="border p-1.5 inset-shadow-gray-500 inset-shadow-sm bg-black overflow-hidden hover:bg-[#323232] transition-all duration-300 ease-in-out rounded-lg allcenter border-[#3c3c3c]"
            >
